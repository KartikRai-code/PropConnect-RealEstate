    ...
    <footer className="bg-gray-900 text-white">
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              <li>123 PropConnect St.</li>
              <li>City, State 12345</li>
              <li>Phone: (123) 456-7890</li>
              <li>Email: info@propconnect.com</li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="flex space-x-4">
              {/* Placeholder Social Icons - Replace href with actual links and potentially use SVG icons */}
        ...
        <div className="mt-8 border-t border-gray-800 pt-8 text-center">
          <p className="text-gray-400">&copy; {new Date().getFullYear()} PropConnect. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
