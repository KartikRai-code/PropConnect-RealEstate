...
const PropertyGrid: React.FC = () => {
  ...
  const displayProperties = () => {
    ...
    // If no search query, show the first 5 properties
          ...
          <div className="overflow-x-auto">
            <div className="flex gap-8 pb-4 snap-x snap-mandatory">
              {propertiesToShow.map((property) => (
                <div
                  key={property._id}
                  className="bg-white rounded-xl shadow-lg overflow-hidden transition-transform duration-300 hover:scale-[1.02] hover:shadow-xl min-w-[350px] max-w-xs snap-start"
